...
const Example = () => {
    ...
    return (
        <Fragment>
            ...
            <aside className="main-sidebar sidebar-dark-primary elevation-4" style={{ overflow: "scroll", width:"250px;"}}>
                    ...
                    <nav className="mt-2" id="MainMenu">
                        <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <a className="nav-link ">
                                       ...
                                       <ul className="nav nav-treeview">
                                           {/*
                                           {form && form.find(form => dep.id === form.department_id )
                                           .map((form, index) =>  ) 
                                                 </ul>
                           </li> )} */}
                             {/* {
                                 form.filter(form =>  form.department_id !== dep.id)
                                 .map((form, index) => 
                                 ...
                                 <Link to="/" className="nav-link">
                                        ...
                                        <p>
                                        { form.department_id }</p>
                                    </Link>
                                      </li>)
                             }  */}
                           {/* {form.filter((form => dep.id !== form.department_id)
...
{/* {department.map((dep) => {
                     form.map((form) => {
                        if(dep.id === form.department_id) {
                            console.log("add user form data", dep.id);
                            console.log("add user form else data", form.department_id);
